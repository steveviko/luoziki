    ...
    return (
        <div className="header">
            ...
            <div className="header_icons">
                ...
                <NotificationsOffIcon className="header_icon" />
